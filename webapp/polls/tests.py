...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        QuestionModelTests.create_question(
            self, question_text="Past question.", days=-30
        )
        response = self.client.get(reverse("polls:index"))
    ...
    def test_future_question(self):
        ...
        """
        QuestionModelTests.create_question(
            self, question_text="Future question.", days=30
        )
        response = self.client.get(reverse("polls:index"))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context["latest_question_list"], [])
    ...
    def test_two_past_questions(self):
        ...
        """
        QuestionModelTests.create_question(
            self, question_text="Past question 1.", days=-30
        )
        QuestionModelTests.create_question(
            self, question_text="Past question 2.", days=30
        )
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        a 404 not found.
        """
        future_question = QuestionModelTests.create_question(
            self, question_text="Future question.", days=5
        )
    ...
    def test_past_question(self):
        ...
        text.
        """
        past_question = QuestionModelTests.create_question(
            self, question_text="Past Question.", days=-5
        )
